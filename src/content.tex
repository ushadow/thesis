...
unintentional hand movements (like beats). The the gestures are further divided
into manipulative and communicative classes. 
...
gestures, the system needs to respond frame by frame while the user is doing
