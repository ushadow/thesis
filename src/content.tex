...
more reasonable and does not affect accuracy very
much. The bottom level in the AHMM consists of observations and states in the 
typical HMM format. HMM is suitable for modeling sequential data such as time 
...
probabilistic output from SVM as proposed by Platt
\cite{Platt99probabilisticoutputs}.
