...
Pavlovic et al. \cite{Pavlovic97} also gives a model for the production and
...
CRF training is much more computatoinally expensive and converges much slower
than those of HMM \cite{lafferty01}. 
...
model parameters such that the objective function can be optimized. We will
explore several commonly used discriminative training criteria and optimiaztion
methods.

\subsubsection{Training criteria and objective functions}

\textbf{Minimum classification error training}
\textbf{Maximum mutual information training}
\textbf{Margin-based training methods}

\subsubsection{Optimizing Parameters}
\textbf{Extended Baum-Welch Method}
